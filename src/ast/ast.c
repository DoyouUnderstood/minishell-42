...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/03/26 16:33:58 by alletond          #+#    #+#             */
/*   Updated: 2024/03/26 16:34:53 by alletond         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
*/
t_ast_node	*ast_create_binary(t_ast_type type, t_ast_node *left, t_ast_node *r)
{
	t_ast_node	*new_node;
